...
(*Denotes a required field)</P>
    ...
    <p><h3>Client Questionnaire</h3>
        <label for="client">First Name: <br><input type="text" placeholder="First Name" value="<?php echo $firstname;?>">
  <span class="error">* <?php echo $firstnameErr;?></span></label>
        <br><br>
        <label for="client">Last Name: <br><input type="text" placeholder="Last Name" value="<?php echo $lastname;?>">
  <span class="error">* <?php echo $lastnameErr;?></span></label>
        <br><br>
        <label for="client">E-Mail: <br><input type="email" placeholder="Email" value="<?php echo $email;?>">
  <span class="error">* <?php echo $emailErr;?></span></label>
        <br><br>
        <label for="client">Confirm E-Mail: <br><input type="email" placeholder="Age" value="<?php echo $email;?>">
  <span class="error">* <?php echo $emailErr;?></span></label>
        <br><br>
    </p>
    <p><h3>Basic Information</h3>
    <Label for="Client">Gender: <br>
  <input type="radio" placeholder="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Female
  <input type="radio" placeholder="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">Male
  <span class="error">* <?php echo $genderErr;?></span>
  <br><br>
    <label for="client">Age<br><input type="text" placeholder="Age" value="<?php echo $age;?>">
  <span class="error">* <?php echo $ageErr;?></span></label>
    <br><br>
    <label for="client">Height<br><input type="text" placeholder="Height (in inches only)" value="<?php echo $height;?>">
  <span class="error">* <?php echo $heightErr;?></span></label>
    <br><br>
    <label for="client">Weight<br><input type="text" placeholder="Weight (in lbs.)" value="<?php echo $weight;?>">
  <span class="error">* <?php echo $weightErr;?></span></label>
    <br><br>
    </p>
    <p><h3>Body Measurements</h3>
    <label for="client">Chest*: <br><br><input type="text" placeholder="Chest (in inches)" value="<?php echo $chest;?>">
  <span class="error">* <?php echo $chestErr;?></span></label><br><br>
    <label for="client">Waist*: <br><input type="text" placeholder="Waist (in inches)" value="<?php echo $waist;?>">
  <span class="error">* <?php echo $waistErr;?></span></label><br><br>
    <label for="client">Hips*: <br><input type="text" placeholder="Hips (in inches)" value="<?php echo $hip;?>">
  <span class="error">* <?php echo $hipErr;?></span></label><br><br>
    <label for="client">Neck: <br><input type="text" placeholder="Neck (in inches)" value="<?php echo $neck;?>">
  <span class="error">* <?php echo $neckErr;?></span></label><br><br>
    <label for="client">Forearm: <br><input type="text" placeholder="Forearm (in inches)" value="<?php echo $forearm;?>">
  <span class="error">* <?php echo $forearmErr;?></span></label><br><br>
    <label for="client">Tricep: <br><input type="text" placeholder="Tricep (in inches)" value="<?php echo $tricep;?>">
  <span class="error">* <?php echo $tricepErr;?></span></label><br><br>
    <label for="client">Bicep: <br><input type="text" placeholder="Bicep (in inches)" value="<?php echo $bicep;?>">
  <span class="error">* <?php echo $bicepErr;?></span></label><br><br>
    <label for="client">Thigh: <br><input type="text" placeholder="Thigh (in inches)" value="<?php echo $thigh;?>">
  <span class="error">* <?php echo $thighErr;?></span></label><br><br>
    <label for="client">Calves: <br><input type="text" placeholder="Calves (in inches)" value="<?php echo $calves;?>">
