...
<nav class="navbar navbar-expand-md navbar-dark" style="background-color: black;">
  <a class="navbar-brand" href="index.php" style="font-family: Russo One;">OVERCLOCKED FITNESS</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="FirstClient.php">Start-Up<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
